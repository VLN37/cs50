...
// 2 - implement a way to print pixels n times vertically by iterating and adding fseek to trace back
...
int main(int argc, char *argv[])
{
    ...
    if (outptr == NULL)
    {
        ...
        //check if width and height are the same as asked by user input
